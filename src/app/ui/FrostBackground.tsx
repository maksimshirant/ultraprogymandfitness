...
// Controls the global frost background fade without coupling it to app routing or modal state.
export function FrostBackground({ pathname }: FrostBackgroundProps) {
