...
export const groupDirections: GroupDirection[] = [
  ...
  },
  {
    ...
    trainer: 'Надежда',
    shortDescription:
      'Адаптивный формат с элементами силы для подвижности суставов, выносливости и безопасного укрепления всего тела.',
    benefits: ['безопасное укрепление всего тела', 'улучшение подвижности суставов', 'развитие функциональной силы и выносливости'],
    category: 'recovery',
    badge: GROUP_DIRECTION_BADGE,
    status: 'Адаптивный формат',
    trainerAvatar: getTrainerAvatar('Надежда'),
    description:
      'Тело в балансе — это вариант адаптивной физической культуры с элементами силы для улучшения мобильности суставов, повышения силы и выносливости.\n\nПрограмма включает суставную гимнастику, упражнения с легкими отягощениями (фитнес-резинки, гантели), функциональные движения и дыхательные техники. Занятия подходят для людей от 13 до 75 лет.\n\nТренер Надежда тщательно подбирает упражнения в соответствии с индивидуальными возможностями участников группы и следит за техникой выполнения, чтобы тренировки были безопасными и приносили только пользу.',
    action: 'group_direction:body_balance',
    bookingAction: 'group_booking_request:body_balance',
    confirmBookingAction: 'group_booking_confirm:body_balance',
  },
  {
    key: 'afk',
  ...
  },
  {
    ...
    trainer: 'Виктория',
    shortDescription:
      'Комплексные упражнения для силы, выносливости, координации и общей физической подготовки.',
  ...
  },
  {
    ...
    trainer: 'Виктория',
    shortDescription:
      'Спокойный формат для гибкости, подвижности суставов и снятия мышечного напряжения.',
