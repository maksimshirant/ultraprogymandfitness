...
export const trainers: TrainerProfile[] = [
  ...
  
  {
    ...
    summary: 'Силовой и функциональный тренинг, коррекция веса и питание',
    achievements: [
      'Дипломированный тренер тренажерного зала',
      'Постановка техники выполнения упражнений',
      'Силовой и функциональный тренинг',
      'Коррекция веса и набор мышечной массы',
      'Консультации по вопросам питания и составление сбалансированного рациона',
    ],
